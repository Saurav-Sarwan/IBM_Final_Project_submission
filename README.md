...
```
Final_Project/
├── SauravSarwan_DMartPricing&Assortment.py   # Main code — run this first
├── requirements.txt                           # pandas, numpy
├── DMart.csv                                  # Source dataset
├── README.md
├── SauravSarwan_ProjectReport.docx            # Report with embedded screenshots
│
├── frontend/
│   └── dashboard.html                         # 3-tab interactive dashboard
│
└── outputs/                                   # Auto-generated by the main script
    ├── kpis.json
